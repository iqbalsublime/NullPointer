...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("   \r\n");
      out.write("   $scope.questions = [{\"title\":\"What is Java?\",\"id\":\"1\"}, {\"title\":\"What is Java Script?\",\"id\":\"2\"}];\r\n");
      out.write("   $scope.title= 'Hello';\r\n");
      out.write("   $scope.hideTable  = true ;\r\n");
      out.write("   $scope.hideButton  = true ;\r\n");
      out.write("   $scope.hidePanel = function(){\r\n");
      out.write("\t   $scope.hideTable  = true ;\r\n");
      out.write("\t   $scope.hideButton  = true ;\r\n");
      out.write("   }; \r\n");
      out.write("   $scope.getData = function(){\r\n");
      out.write("\t   console.log(\"Controller hit!\");\r\n");
      out.write("\t   $http({\r\n");
      out.write("\t\t    url: '/getAll.json',\r\n");
      out.write("\t\t    method: 'GET',\r\n");
      out.write("\t\t    headers: {\r\n");
      out.write("\t\t    \t\"Content-Type\": \"application/json\"\r\n");
      out.write("\t\t    }\r\n");
      out.write("\t\t    }).success(function(response){\r\n");
      out.write("\t\t        $scope.data = response;\r\n");
      out.write("\t\t        console.log($scope.data);\r\n");
      out.write("\t\t       /*  $scope.hideTable = false;\r\n");
      out.write("\t\t        $scope.hideButton  = false ; */\r\n");
      out.write("\t\t    }).error(function(error){\r\n");
      out.write("\t\t        $scope.data = error;\r\n");
      out.write("\t\t        console.log(\"Failed\");\r\n");
      out.write("\t\t});\r\n");
      out.write("   };\r\n");
      out.write("   \r\n");
      out.write("   $scope.add = function(id){\r\n");
      out.write("\t   console.log(\"Controller hit!\");\r\n");
      out.write("\t   console.log(id);\r\n");
      out.write("\t   $http({\r\n");
      out.write("\t\t    url: '/mkyoung.json',\r\n");
      out.write("\t\t    method: 'GET',\r\n");
      out.write("\t\t    headers: {\r\n");
      out.write("\t\t    \t\"Content-Type\": \"application/json\"\r\n");
      out.write("\t\t    }\r\n");
      ...
      out.write("\t\t        console.log($scope.response);\r\n");
      out.write("\t\t       /*  $scope.hideTable = false;\r\n");
      out.write("\t\t        $scope.hideButton  = false ; */\r\n");
      out.write("\t\t    }).error(function(error){\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t<a data-ng-click=\"getData()\">Get List</a>\r\n");
      out.write("\t\t\t\t\t<div class=\"container\" ng-hide=\"hideButton\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t <button type=\"button\" class=\"btn btn-sm active btn-success\" data-ng-click=\"hidePanel()\">Hide Table</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"container\" ng-hide=\"hideTable\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row clearfix\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr data-ng-repeat=\"person in responses\" class=\"success\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{{person.city}}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{{person.phone}}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"container\" data-ng-repeat=\"question in questions\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\" column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a data-ng-click=\"add(question.id)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{title}}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{question.title}}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</a> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<small>On  </small>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"container\" ng-app=\"mainApp\" ng-controller=\"studentController\">\r\n");
      out.write("\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t<div class=\"col-md-11 column\">\r\n");
      out.write("\t\t\t<div class=\"row clearfix\">\r\n");
      out.write("\t\t\t\t<div class=\"col-md-6 column\">\r\n");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${empty user.questions}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\tThere is no question of this user\r\n");
        out.write("\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty user.questions}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.questions}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_set_0.setVar("quesTitle");
    _jspx_th_c_set_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(question.title, 0, 30)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_out_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${quesTitle}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_out_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${question.publishedDate}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${empty user.answers}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\tThere is no answer of this user\r\n");
        out.write("\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty user.answers}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_forEach_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.answers}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_spring_url_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_spring_url_1.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/question/${answer.question.id}.html", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_1.setVar("ansTitle");
    _jspx_th_c_set_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(answer.question.title, 0, 30)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_out_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ansTitle}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_2.setVar("des");
    _jspx_th_c_set_2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(answer.description, 0, 30)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_out_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${des}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_out_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_4.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${answer.publishedDate}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_4(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${empty user.answers}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_5(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty user.answers}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.answers}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_2.setVar("answer");
  ...
  private boolean _jspx_meth_spring_url_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_spring_url_2.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/question/${answer.question.id}.html", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_set_3.setVar("ansTitle");
    _jspx_th_c_set_3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(answer.question.title, 0, 30)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_out_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_out_5.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ansTitle}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_set_4.setVar("des");
    _jspx_th_c_set_4.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(answer.description, 0, 30)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_out_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_out_6.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${des}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_out_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_out_7.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${answer.publishedDate}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
